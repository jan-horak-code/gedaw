...
compareclrrow = function (a,b,ce=1,co="red",vh=0.95,rh=0.85,main=NULL,main.ce=3,main.line=0.75){

# comment:
	# function compares the input and output of the clrcol function and returns plots of variables comapred and vector of R^2
